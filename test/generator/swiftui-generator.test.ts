...
describe('Entity Resolution', () => {
  ...
  test('dashboard state and body use same entity resolution', () => {
    const model: SemanticAppModel = {
  ...
  test('profile screen declares entity state variable', () => {
    const model: SemanticAppModel = {
  ...
  test('data requirement uses resolved entity type for state declaration', () => {
    const model: SemanticAppModel = {
  ...
  test('loadData uses networking generator function name for matching endpoint', () => {
    const model: SemanticAppModel = {
